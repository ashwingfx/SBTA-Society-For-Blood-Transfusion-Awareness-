...
*/
  ...
  Future<void> addUser(BuildContext context) {
    return students
        .add({'email': emailController.text, 'phone': passwordController.text})
        .then((value) => {ScaffoldMessenger.of(context).showSnackBar(SnackBar(content:Text("Added Successfully")))})
        .catchError((e) =>{ScaffoldMessenger.of(context).showSnackBar(SnackBar(content:Text("Faild to Add $e")))});
  }

  Future<void> registraion(BuildContext context) async {
    try {
